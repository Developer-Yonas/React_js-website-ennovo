...
export default function Form() {
  ...
  <div className="max">
    ...
    <div id='form' ref={ScrollRef} className={hiddenSection? 'hiddenSection section6' : 'section6'}>
        ...
        <div className="container">
          {/*}  <div className="s6Left">
            ...
            <div className="s6Center">
                ...
                <div className="top">
                     <label>Do you want to get to know us better?</label>
                </div>  
                    ...
                    <span>I want to subscribe to the newsletter and receive information on Sinfonialab initiatives*</span>
                    <br /><br />
